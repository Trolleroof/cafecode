      ...
      <div className="bg-[#FDF8F3] rounded-3xl shadow-[0_20px_60px_rgba(0,0,0,0.25)] w-full max-w-3xl px-7 py-6 relative border border-[#E5D6C5]">
        ...
        {isSubmitting && (
          <div className="mb-6 text-center">
            <div className="w-full h-2 bg-cream-beige rounded-full overflow-hidden mb-3">
              <div className="h-full bg-medium-coffee animate-pulse relative">
                <div className="h-full bg-gradient-to-r from-medium-coffee to-deep-espresso animate-pulse" style={{ width: '100%' }} />
                <div className="absolute top-0 left-0 h-full w-1/3 bg-white/30 animate-pulse" style={{ 
